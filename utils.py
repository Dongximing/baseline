...
def load_emb_matrix(vocab_size, emb_size, data):
  embedding_weights = {}
  f = open('/content/drive/My Drive/DuplicateBugFinder/glove.42B.{}d.txt'.format(emb_size), 'r')
  loop = tqdm(f)
...
if __name__ == '__main__':
  vocab = load_vocabulary('/content/drive/My Drive/DuplicateBugFinder/openOffice/word_vocab.pkl')
  for token in vocab:
    print(token)
