...
parser.add_argument('-nw', '--n_words', type=int, default=200000)
...
parser.add_argument('-lr', '--learning_rate', type=float, default=1e-3) #5e-5
...
def main():
  ...
  for epoch in range(1, args.epochs + 1):
      ...
      for loop, (batch_x, batch_pos, batch_neg) in data_generator.batch_iterator(args.data, args.batch_size,1):
          losses =[]
          net.zero_grad()
          pred = net(batch_x)
